...
Şehir / Eyalet = {zone}<br />
Şehir / Eyalet Kodu = {zone_code}<br />
Ülke = {country}</span>';
...
$_['error_zone']              = 'Uyarı: Bu ülkeyi silemezsiniz. Bu ülke %s şehirde / eyalette kullanılıyor!';
$_['error_zone_to_geo_zone']  = 'Uyarı: Bu ülkeyi silemezsiniz. Bu ülke %s genel bölgede kullanılıyor!';
?>