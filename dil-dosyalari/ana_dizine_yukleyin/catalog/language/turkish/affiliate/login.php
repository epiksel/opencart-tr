...
$_['text_description']				= '<p>%s ortaklık programına kayıt olmak ücretsizdir. Oluşturacağınız takip kodunu kendi web sitenizde, sosyal ağ hesaplarınızda ya da her hangi bir yerde paylaşabilir ve takip kodunuz ile gelen müşteriler %s sitemizde bulunan ürünleri satın aldığında, belirlediğimiz komisyon oranlarında sizde gelir elde edersiniz. Şuan ki geçerli komisyon oranımız %s\'dir.</p><p>Daha fazla bilgi için, Ortaklık Programı Kullanımı &amp; Koşullarına bakabilirsiniz.</p>';
