...
$_['entry_company_id_display']	= 'Vergi Dairesini Göster:<br /><span class="help">Vergi dairesi alanını göster</span>';
$_['entry_company_id_required']	= 'Vergi Dairesi Gerekli:<br /><span class="help">Ödeme öncesi bu müşteri grubu için vergi dairesi girmek zorunlu kılın.</span>';
$_['entry_tax_id_display']		= 'T.C/Vergi No Göster:<br /><span class="help">Fatura adreslerinde t.c./vergi numarasını göster.</span>';
$_['entry_tax_id_required']		= 'T.C/Vergi No Gerekli:<br /><span class="help">Ödeme öncesi bu müşteri grubu için t.c./vergi bumarası girmek zorunlu kılın.</span>';
