...
class ModelUpgrade extends Model {
	public function mysql() {
		...
		if (!isset($table_data[DB_PREFIX . 'address']['company_id'])) {
			$db->query("ALTER TABLE " . DB_PREFIX . "address ADD company_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER company");
		}

		if (!isset($table_data[DB_PREFIX . 'address']['tax_id'])) {
			$db->query("ALTER TABLE " . DB_PREFIX . "address ADD tax_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER company_id");
		}
		...
		if (!isset($table_data[DB_PREFIX . 'affiliate'])) {
			...
			$db->query("ALTER TABLE `oc_affiliate` ADD `salt` varchar(9) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' after `password`");				
		}
		...
		$db->query("DROP TABLE IF EXISTS `oc_attribute`;
		...
		$db->query("DROP TABLE IF EXISTS `oc_attribute_description`;
		...
		$db->query("DROP TABLE IF EXISTS `oc_attribute_group`;
		...
		$db->query("DROP TABLE IF EXISTS `oc_attribute_group_description`;
		...
		$db->query("DROP TABLE IF EXISTS `oc_banner_image`;
		...
		$db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "tax_rule` (
			...
			tax_rate_id int(11) NOT NULL DEFAULT 0 COMMENT '',
			based varchar(10) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			priority int(5) NOT NULL DEFAULT '1' COMMENT '',
			PRIMARY KEY (tax_rule_id)
		) DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci");
		
		$db->query("ALTER TABLE `" . DB_PREFIX . "customer` ADD token varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER approved");
		$db->query("ALTER TABLE `" . DB_PREFIX . "option_value` ADD image varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER option_id");
		$db->query("ALTER TABLE `" . DB_PREFIX . "order` MODIFY invoice_prefix varchar(26) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci");
		$db->query("ALTER TABLE `" . DB_PREFIX . "product_image` ADD sort_order int(3) NOT NULL DEFAULT '0' COMMENT '' AFTER image");
		$db->query("ALTER TABLE `" . DB_PREFIX . "tax_rate` ADD name varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER geo_zone_id");
		$db->query("ALTER TABLE `" . DB_PREFIX . "tax_rate` ADD type char(1) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER rate");
		...
		$db->query("CREATE TABLE IF NOT EXISTS oc_customer_ip_blacklist (
			...
			ip varchar(15) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
		...
		$db->query("CREATE TABLE IF NOT EXISTS oc_order_fraud (
			...
			country_match varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			country_code varchar(2) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			high_risk_country varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			distance int(11) NOT NULL DEFAULT 0 COMMENT '',
			ip_region varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_city varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_latitude decimal(10,6) NOT NULL DEFAULT '' COMMENT '',
			ip_longitude decimal(10,6) NOT NULL DEFAULT '' COMMENT '',
			ip_isp varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_org varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_asnum int(11) NOT NULL DEFAULT 0 COMMENT '',
			ip_user_type varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_country_confidence varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_region_confidence varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_city_confidence varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_postal_confidence varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_postal_code varchar(10) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_accuracy_radius int(11) NOT NULL DEFAULT 0 COMMENT '',
			ip_net_speed_cell varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_metro_code int(3) NOT NULL DEFAULT 0 COMMENT '',
			ip_area_code int(3) NOT NULL DEFAULT 0 COMMENT '',
			ip_time_zone varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_region_name varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_domain varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_country_name varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_continent_code varchar(2) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ip_corporate_proxy varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			anonymous_proxy varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			proxy_score int(3) NOT NULL DEFAULT 0 COMMENT '',
			is_trans_proxy varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			free_mail varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			carder_email varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			high_risk_username varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			high_risk_password varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_match varchar(10) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_country varchar(2) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_name_match varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_name varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_phone_match varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			bin_phone varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			customer_phone_in_billing_location varchar(8) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ship_forward varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			city_postal_match varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			ship_city_postal_match varchar(3) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			score decimal(10,5) NOT NULL DEFAULT '' COMMENT '',
			explanation text NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			risk_score decimal(10,5) NOT NULL DEFAULT '' COMMENT '',
			queries_remaining int(11) NOT NULL DEFAULT 0 COMMENT '',
			maxmind_id varchar(8) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			error text NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
		...
		$db->query("CREATE TABLE IF NOT EXISTS oc_order_voucher (
			...
			description varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			code varchar(10) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			from_name varchar(64) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			from_email varchar(96) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			to_name varchar(64) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			to_email varchar(96) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			voucher_theme_id int(11) NOT NULL DEFAULT 0 COMMENT '',
			message text NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			amount decimal(15,4) NOT NULL DEFAULT '' COMMENT '',
			PRIMARY KEY (order_voucher_id)
		) DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci");
		
		$db->query("ALTER TABLE oc_order ADD shipping_code varchar(128) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER shipping_method");
		$db->query("ALTER TABLE oc_order ADD payment_code varchar(128) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER payment_method");
		$db->query("ALTER TABLE oc_order ADD forwarded_ip varchar(15) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER ip");
		$db->query("ALTER TABLE oc_order ADD user_agent varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER forwarded_ip");
		$db->query("ALTER TABLE oc_order ADD accept_language varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER user_agent");
		...
		$db->query("ALTER TABLE `oc_return` ADD `product` varchar(255) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER `telephone`");
		$db->query("ALTER TABLE `oc_return` ADD `model` varchar(64) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER `product`");
		...
		$db->query("ALTER TABLE oc_tax_rate_to_customer_group DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci");
		...
		$db->query("CREATE TABLE IF NOT EXISTS oc_customer_group_description (
			...
			name varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			description text NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci,
			PRIMARY KEY (customer_group_id, language_id)
		) DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci");
		
		$db->query("ALTER TABLE oc_address ADD company_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER company");
		$db->query("ALTER TABLE oc_address ADD tax_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER company_id");
		...
		$db->query("ALTER TABLE `oc_order` ADD payment_company_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER payment_company");
		$db->query("ALTER TABLE `oc_order` ADD payment_tax_id varchar(32) NOT NULL DEFAULT '' COMMENT '' COLLATE utf8_turkish_ci AFTER payment_company_id");
		...
		$db->query("ALTER TABLE `oc_customer` ADD `salt` varchar(9) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `password`");
		...
		$db->query("ALTER TABLE `oc_product` ADD `ean` varchar(12) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `upc`");
		$db->query("ALTER TABLE `oc_product` ADD `jan` varchar(12) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `ean`");
		$db->query("ALTER TABLE `oc_product` ADD `isbn` varchar(12) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `jan`");
		$db->query("ALTER TABLE `oc_product` ADD `mpn` varchar(12) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `isbn`");
		$db->query("ALTER TABLE `oc_product_description` ADD `tag` text COLLATE utf8_turkish_ci NOT NULL DEFAULT '' AFTER `meta_keyword`");
		...
		$db->query("ALTER TABLE `oc_user` ADD `salt` varchar(9) COLLATE utf8_turkish_ci NOT NULL DEFAULT '' after `password`");
