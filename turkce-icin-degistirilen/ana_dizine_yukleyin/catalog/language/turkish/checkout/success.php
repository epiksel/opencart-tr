...
// Text
$_['text_customer']	= '<p>Siparişiniz başarıyla işleme alınmıştır!</p><p>Hesabınızı görüntülemek için <a href="%s">buraya</a>, sipariş geçmişiniz için <a href="%s">buraya</a> tıklayınız.</p><p>Eğer dosya içeren ürün satın aldıysanız, <a href="%s">Dosyalarım</a> sayfasına bakınız.</p><p>Herhangi bir sorunuz varsa <a href="%s">buraya tıklayın</a>.</p><p>Bizi tercih ettiğiniz için teşekkür ederiz.</p>';
